...
public final class PhaseTransitions {
     ...
     * de victoire pour l'instant, voir 05-etat-et-problemes-connus.md), recalcule le total
     * de la nouvelle vague à partir des spawners actifs, et "respawn" (redevient visible/
     * solide) tous les coffres de mana ouverts pendant la vague précédente.
     */
