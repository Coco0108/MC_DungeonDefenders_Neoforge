...
| Maps / Monde | Commande `/dd_export <map>` produisant un jar d'extension prêt à publier (mods.toml généré + structure + aperçu). | Moyen | Faite | Fait le 2026-09-02 : `MapExporter` + `/dd_export <namespace>`, un jar par pack. Voir [02-gameplay.md](02-gameplay.md#dd_export-namespace--le-jar-est-généré-pour-toi). |
